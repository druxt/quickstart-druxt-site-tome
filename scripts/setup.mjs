 ...
 * makes `npx giget gh:druxt/quickstart-druxt-site-tome my-site --install` install
...
async function doSetup({ splash }) {
  ...
  console.log('Setting up the Druxt quickstart (Tome) (Drupal backend + Nuxt frontend)...')
  console.log('')
