...
const dbFile = process.env.DB_FILE || readEnv().DB_FILE || '/tmp/quickstart-tome-drupal-site.sqlite'
const logFile = '/tmp/quickstart-tome-drupal-php-server.log'
const pidFile = '/tmp/quickstart-tome-drupal-php-server.pid'
