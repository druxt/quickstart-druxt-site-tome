...
function server_pid_file(): string {
  ...
  return sprintf('/tmp/quickstart-tome-drupal-php-server-%s.pid', substr(md5((string) getcwd()), 0, 8));
}
...
// @codeCoverageIgnoreStart
if (!function_exists('QuickstartTomeDevTools\quit') && !class_exists('PHPUnit\\Framework\\TestCase')) {
